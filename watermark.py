...
def open_img():
    ...
    img = img.resize((800, 525), Image.ANTIALIAS)
...
def save_img():
    ...
    grabcanvas.save(fp=filedialog.asksaveasfilename(initialdir = "/",title = "Select A File",filetypes = (("jpeg files","*.jpg"),("all files","*.*")),  defaultextension ='*.jpg'))

window = Tk()
window.title("WatermarkImg")
window.minsize(width = 980, height = 700)
